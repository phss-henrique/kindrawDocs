...
sidebar_position: 1
title: Cronograma
description: Linha do tempo detalhada do desenvolvimento do projeto MOBI AI, com entregas mensais e marcos principais.
---
...
|------------|---------------------------------------------------------------------------------------------|
| **Janeiro**  | Definição do tema do projeto (MKR), reuniões iniciais, levantamento de problemas e soluções |
| **Fevereiro**| Estudo de ferramentas (Azure, OpenAI, APIs, LangChain), testes preliminares, definição de UX |
| **Março**    | Início do desenvolvimento, integração OpenAI, automação PowerPoint, pesquisa com usuários |
| **Abril**    | Prototipação UX/UI, criação da newsletter, avanço IA de extração, documentação de requisitos |
| **Maio**     | Finalização do MVP, testes internos, correção de falhas, início da documentação final         |
| **Junho**    | Finalização da documentação, gravação do pitch, entrega final e alinhamento com a área       |
...
> O cronograma do MOBI AI foi planejado para garantir evolução contínua e entregas de valor ao longo de todo o projeto, equilibrando aprendizado, execução técnica e usabilidade.
